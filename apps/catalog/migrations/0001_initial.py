    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='catalog.author', verbose_name='Автор')),
                ('categories', models.ManyToManyField(related_name='books', to='catalog.category', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Книга',
                'verbose_name_plural': 'Книги',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['title'], name='catalog_boo_title_3a1ffe_idx'), models.Index(fields=['isbn'], name='catalog_boo_isbn_43f845_idx'), models.Index(fields=['average_rating'], name='catalog_boo_average_aac2c9_idx'), models.Index(fields=['price'], name='catalog_boo_price_779a36_idx')],
            },
        ),
    ]
